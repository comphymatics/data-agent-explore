...
const edges: ContextEdge[] = [
  ...
  edge("edge:churn-computed-terminated", "indicator:churn-rate", "COMPUTED_FROM", "measure:terminated-subscriptions"),
  edge("edge:churn-computed-active", "indicator:churn-rate", "COMPUTED_FROM", "measure:active-subscriptions"),
  ...
  edge("edge:drop-rate-drop", "indicator:drop-call-rate", "COMPUTED_FROM", "measure:drop-calls"),
  edge("edge:drop-rate-calls", "indicator:drop-call-rate", "COMPUTED_FROM", "measure:calls"),
